...
class MicroManagerDialog			//Dialog class name, gets called by: handle = CreateDialog "name"
{
	idd = 9010;						//Display control number
	...
	class controls {
		...
		class RscListbox_screens : RscListbox  //////////////////////////////////////List Screens
		{
			idc = 1555;
			x = .10;// 1 * GUI_GRID_W + GUI_GRID_X;
		...
		class RscText_Header : RscText
		{
			...
			text = "420 COMMAND - Micro Manager";				//text field
			fixedWidth = 0;				//0,1
